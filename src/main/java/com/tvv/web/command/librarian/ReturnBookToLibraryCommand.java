...
/**
 * This command show information about return book via send JSON response
 */
@LibrarianLevel
public class ReturnBookToLibraryCommand extends Command {

    private static final Logger log = Logger.getLogger(ReturnBookToLibraryCommand.class);

    private BookService bookService;

    public ReturnBookToLibraryCommand() {
