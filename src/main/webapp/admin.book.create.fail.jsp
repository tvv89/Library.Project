...
<html>
<head>
    <title><fmt:message key="fail.book.header"/></title>
...
<div class="uk-align-center uk-position-center">
    <img class="uk-preserve-width uk-border-pill uk-align-center"
         src="images/fail.png"
         width="300" alt="">
    <h1 class="uk-align-center"><fmt:message key="fail.book.header"/></h1>
    <p class="uk-align-center"><fmt:message key="fail.book.message"/></p>
